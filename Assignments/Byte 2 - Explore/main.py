...
API_KEY = 'AIzaSyAZBUgbEcVgXIbGaECFa9v-2yyE8U5oBig'
...
TABLE_ID = '1GvQkfmw9YPQllPApoEkd6nY9ScMjcit0DBtiZEXj'

# This is the default columns for the query
query_cols = []
query_values = ['2016'] #Change to be the value(s) you're querying in the column you've specified
...
def get_all_data(query):
    ...
    #query = "SELECT * FROM " + TABLE_ID + " WHERE  score = '100' LIMIT 5"
